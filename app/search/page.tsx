 ...
 * Parses URL parameters to filter and display posts matching a user's search query.
 */
export default async function SearchPage({
  ...
  // Parse search query and active filters (time-range and content-type)
  ...
  // Security Check: Restricted users cannot perform searches
  if (viewerUserId) {
  ...
  // Fetch search results from the database if a query is provided
  const posts = query
    ? await searchPosts({
      viewerUserId,
      query,
